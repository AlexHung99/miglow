...
window.MIGLOW_DATA = {
  ...
  banners: [
    {
      ...
      image_path: "assets/images/brand/hero.png",
    ...
    },
    {
      ...
      image_path: "assets/images/brand/bags.png",
      link_url: "about.html",
      link_label: "認識微光",
      sort_order: 2,
      is_active: true
    },
    {
      ...
      title: "三種口味・三種幸福",
      subtitle: "原味、草莓、巧克力，\n每一口都是純手作的細緻。",
      image_path: "assets/images/products/p-strawberry.png",
      link_url: "products.html",
      link_label: "看更多",
      sort_order: 3,
      is_active: true
  ...
  products: [
    ...
    },
    {
      ...
      price: 300,
      image_path: "assets/images/products/p-chocolate.png",
      category: "snowflake",
      sort_order: 2,
      is_active: true,
      is_featured: true
    },
    {
      ...
      price: 260,
      image_path: "assets/images/products/p-original.png",
      category: "snowflake",
      sort_order: 3,
      is_active: true,
      is_featured: true
  ...
  news: [
    {
      ...
      cover_image_path: "assets/images/brand/hero.png",
    ...
    },
    {
      ...
      cover_image_path: "assets/images/products/p-original.png",
    ...
    },
    {
      ...
      cover_image_path: "assets/images/brand/bags.png",
    ...
    },
    {
      ...
      category: "新品上市",
      title: "草莓季限定・酸甜上市",
      cover_image_path: "assets/images/products/p-strawberry.png",
  ...
  pages: {
    about: {
      hero_image: "assets/images/brand/bags.png",
